...
var Util = {
  ...
  //name of transition
  previousDataTrans: '',
  //name of previous transition
  dataPage: '',
  //after using barba name of page
  pageType: '',
  //either primary or secondary page - not always checked atm 3 march
  primaryPage: false,
  ...
  getURLPath: function getURLPath() {
    ...
    this.parsedUrl = new URL(window.location.href); // const regex = /\//ig;
    // let justThePath = this.parsedUrl.pathname.replace(regex,'')

    return this.parsedUrl.pathname; //.split("/")[1]
  },
  getRootURLPath: function getRootURLPath() {
    //   !!Important that permalink in settings does not have trailing '/'
    this.parsedUrl = new URL(window.location.href);
    return this.parsedUrl.pathname.split('/')[1];
  },
  getExtendedURLPath: function getExtendedURLPath() {
    this.parsedUrl = new URL(window.location.href);
    return this.parsedUrl.pathname;
  },
  searchPageUrl: function searchPageUrl(findPage) {
    this.parsedUrl = new URL(window.location.href);
    var urlArray = this.parsedUrl.pathname.split('/');
    var findPath = urlArray.includes(findPage, 1) ? true : false;
    return findPath;
  },
  searchPathNameArray: function searchPathNameArray(match) {
    //used to find say 'product' in /store/product/2019...
    var pathArray = window.location.pathname.split('/');
    var found;
    pathArray.find(function (el, idx) {
      return el === match ? found = true : found = false;
    });
    return found;
  },
  keys: {
  ...
  disableScroll: function disableScroll(yPixel) {
  ...
  enableScroll: function enableScroll(yPixel) {
  ...
  setCSSvariable: function setCSSvariable() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_util.js */ "./src/js/_util.js");

var App = {
  sayHelloTest: function sayHelloTest(fName) {
...
/* harmony import */ var _vendor_slick__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/slick */ "./src/js/vendor/slick.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  _app__WEBPACK_IMPORTED_MODULE_2__["default"].init();
});
